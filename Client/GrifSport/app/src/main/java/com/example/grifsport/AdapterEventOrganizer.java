...
public class AdapterEventOrganizer extends  RecyclerView.Adapter<AdapterEventOrganizer.HolderOneNoteOrganizer> implements Filterable  {

    //private OnNoteListener listener;
    private String access;
    private Context context;
    public java.util.ArrayList<EventResponse> ArrayList,filterList;
    private ActivityOneEventOrganizerBinding binding;
    java.util.ArrayList <Integer> ListId = new ArrayList<>();
   // private  FilterNote filter;

    //private  FilterPdfUser filter;
    //фрагмент одной кв.
    public AdapterEventOrganizer(Context context, java.util.ArrayList<EventResponse> pdfArrayList, String access) {
    ...
    @Override
    public HolderOneNoteOrganizer onCreateViewHolder( ViewGroup parent, int viewType) {
        binding = ActivityOneEventOrganizerBinding.inflate(LayoutInflater.from(context),parent,false);

        this.context=parent.getContext();
        return new HolderOneNoteOrganizer(binding.getRoot());
    }
    ...
    @Override
    public void onBindViewHolder( HolderOneNoteOrganizer holder, int position) {
    ...
    class HolderOneNoteOrganizer extends RecyclerView.ViewHolder{
        ImageView circleImageView;
        TextView NoteDescription,NoteDate,NoteAssesment;
        CardView cardView;
        public HolderOneNoteOrganizer( View itemView) {
            super(itemView);
