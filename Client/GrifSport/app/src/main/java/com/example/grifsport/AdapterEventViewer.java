...
import com.example.grifsport.databinding.ActivityOneEventViewerBinding;

import java.util.ArrayList;

public class AdapterEventViewer extends  RecyclerView.Adapter<AdapterEventViewer.HolderOneNoteViewer> implements Filterable  {

    //private OnNoteListener listener;
    private String access;
    private Context context;
    public java.util.ArrayList<EventResponse> ArrayList,filterList;
    private ActivityOneEventViewerBinding binding;
    java.util.ArrayList <Integer> ListId = new ArrayList<>();
   // private  FilterNote filter;

    //private  FilterPdfUser filter;
    //фрагмент одной кв.
    public AdapterEventViewer(Context context, java.util.ArrayList<EventResponse> pdfArrayList, String access) {
    ...
    @Override
    public HolderOneNoteViewer onCreateViewHolder( ViewGroup parent, int viewType) {
        binding = ActivityOneEventViewerBinding.inflate(LayoutInflater.from(context),parent,false);

        this.context=parent.getContext();
        return new HolderOneNoteViewer(binding.getRoot());
    }
    ...
    @Override
    public void onBindViewHolder( HolderOneNoteViewer holder, int position) {
    ...
    class HolderOneNoteViewer extends RecyclerView.ViewHolder{
        ImageView circleImageView;
        TextView NoteDescription,NoteDate,NoteAssesment;
        CardView cardView;
        public HolderOneNoteViewer( View itemView) {
            super(itemView);
