 ...
 * Use the {@link EventsAllFragmentOrganizer#newInstance} factory method to
 * create an instance of this fragment.
 */

public class EventsAllFragmentOrganizer extends Fragment {
    int count = 0;
    ...
    private OrganizerFragmentAllEventsBinding binding;
    private AdapterEventOrganizer adapterNote; //одна квартира

    public EventsAllFragmentOrganizer() {
        // Required empty public constructor
    }

    public EventsAllFragmentOrganizer(String access) {
        accessToken = access;
        // Required empty public constructor
    }
    ...
    @NotNull
    public static EventsAllFragmentOrganizer newInstance(Integer assessment, String description, String date, String access) {
        EventsAllFragmentOrganizer fragment = new EventsAllFragmentOrganizer();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = OrganizerFragmentAllEventsBinding.inflate(LayoutInflater.from(getContext()), container, false);
                            ...
                            if (response.isSuccessful()) {
                                ...
                                for (int i = 0; i < response.body().size(); i++) {
                                    ...
                                    if (model1.getIs_active() == false) {
                                        ...
                                        count++;
                                        adapterNote = new AdapterEventOrganizer(getContext(), ArrayList, accessToken); //лист с экз-ами доступных кв.
