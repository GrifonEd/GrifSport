...
import com.example.grifsport.databinding.ActivityInfoEventForApplicationBinding;
...
public class InfoEventForApplicationActivity extends AppCompatActivity {
    String access="";
    Bundle bundle;
    int event_id;
    int profile_id;
    String id;
    ActivityInfoEventForApplicationBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityInfoEventForApplicationBinding.inflate(getLayoutInflater());
            ...
            public void onResponse(Call<EventResponse> call, Response<EventResponse> response) {
                if(response.isSuccessful()){
                   binding.eventName.setText(response.body().getName());
                    ...
                    binding.EventDesciplines.setText(response.body().getSport().getName());
        ...
        binding.applicationCreate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                bundle = new Bundle();
                bundle.putInt("event_id", event_id);
                bundle.putInt("profile_id", profile_id);
                DialogFragmentForApplication dialogFragmentMy=new DialogFragmentForApplication();
