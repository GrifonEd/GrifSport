...
public class WorkerProfileFragment extends Fragment {
    String access;
    ViewPager viewPager;
   ViewPagerAdapter viewPagerAdapterWorker ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager = rootView.findViewById(R.id.viewPagerWorker);
    ...
    private void setupViewPagerAdapter(final ViewPager viewPager){
        ...
        viewPagerAdapterWorker = new ViewPagerAdapter(getChildFragmentManager(), FragmentPagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT,getActivity());

        //его создание
        viewPagerAdapterWorker.addFragment(EventsAllFragmentWorker.newInstance(
                2,
                "",
                "",access
        ));

        viewPagerAdapterWorker.notifyDataSetChanged();

        viewPager.setAdapter(viewPagerAdapterWorker);
    }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter{
        ...
        private ArrayList<EventsAllFragmentWorker> fragmentList = new ArrayList<>();
        ...
        void addFragment(EventsAllFragmentWorker fragment){
