...
import com.example.grifsport.databinding.ActivityOneEventParticipantBinding;

import java.util.ArrayList;

public class AdapterEventParticipant extends  RecyclerView.Adapter<AdapterEventParticipant.HolderOneNoteParticipant> implements Filterable  {

    //private OnNoteListener listener;
    private String access;
    private Context context;
    public java.util.ArrayList<EventResponse> ArrayList,filterList;
    private ActivityOneEventParticipantBinding binding;
    java.util.ArrayList <Integer> ListId = new ArrayList<>();
   // private  FilterNote filter;

    //private  FilterPdfUser filter;
    //фрагмент одной кв.
    public AdapterEventParticipant(Context context, java.util.ArrayList<EventResponse> pdfArrayList, String access) {
    ...
    @Override
    public HolderOneNoteParticipant onCreateViewHolder( ViewGroup parent, int viewType) {
        binding = ActivityOneEventParticipantBinding.inflate(LayoutInflater.from(context),parent,false);

        this.context=parent.getContext();
        return new HolderOneNoteParticipant(binding.getRoot());
    }
    ...
    @Override
    public void onBindViewHolder( HolderOneNoteParticipant holder, int position) {
    ...
    class HolderOneNoteParticipant extends RecyclerView.ViewHolder{
        ImageView circleImageView;
        TextView NoteDescription,NoteDate,NoteAssesment;
        CardView cardView;
        public HolderOneNoteParticipant( View itemView) {
            super(itemView);
