...
import com.example.grifsport.databinding.ActivityOneEventJudgeBinding;
import com.example.grifsport.databinding.ActivityOneEventOrganizerBinding;

import java.util.ArrayList;

public class AdapterEventJudge extends  RecyclerView.Adapter<AdapterEventJudge.HolderOneNoteJudge> implements Filterable  {

    //private OnNoteListener listener;
    private String access;
    private Context context;
    public java.util.ArrayList<EventResponse> ArrayList,filterList;
    private ActivityOneEventJudgeBinding binding;
    java.util.ArrayList <Integer> ListId = new ArrayList<>();
   // private  FilterNote filter;

    //private  FilterPdfUser filter;
    //фрагмент одной кв.
    public AdapterEventJudge(Context context, java.util.ArrayList<EventResponse> pdfArrayList, String access) {
    ...
    @Override
    public HolderOneNoteJudge onCreateViewHolder( ViewGroup parent, int viewType) {
        binding = ActivityOneEventJudgeBinding.inflate(LayoutInflater.from(context),parent,false);

        this.context=parent.getContext();
        return new HolderOneNoteJudge(binding.getRoot());
    }
    ...
    @Override
    public void onBindViewHolder( HolderOneNoteJudge holder, int position) {
    ...
    class HolderOneNoteJudge extends RecyclerView.ViewHolder{
        ImageView circleImageView;
        TextView NoteDescription,NoteDate,NoteAssesment;
        CardView cardView;
        public HolderOneNoteJudge( View itemView) {
            super(itemView);
