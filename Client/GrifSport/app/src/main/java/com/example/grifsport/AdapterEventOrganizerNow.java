...
import com.example.grifsport.databinding.ActivityOneEventOrganizerNowBinding;

import java.util.ArrayList;

public class AdapterEventOrganizerNow extends  RecyclerView.Adapter<AdapterEventOrganizerNow.HolderOneNoteOrganizerNow> implements Filterable  {

    //private OnNoteListener listener;
    private String access;
    private Context context;
    public java.util.ArrayList<EventResponse> ArrayList,filterList;
    private ActivityOneEventOrganizerNowBinding binding;
    java.util.ArrayList <Integer> ListId = new ArrayList<>();
   // private  FilterNote filter;

    //private  FilterPdfUser filter;
    //фрагмент одной кв.
    public AdapterEventOrganizerNow(Context context, java.util.ArrayList<EventResponse> pdfArrayList, String access) {
    ...
    @Override
    public HolderOneNoteOrganizerNow onCreateViewHolder( ViewGroup parent, int viewType) {
        binding = ActivityOneEventOrganizerNowBinding.inflate(LayoutInflater.from(context),parent,false);

        this.context=parent.getContext();
        return new HolderOneNoteOrganizerNow(binding.getRoot());
    }
    ...
    @Override
    public void onBindViewHolder( HolderOneNoteOrganizerNow holder, int position) {
        ...
        String date = model.getEvent_start_date();
        Log.e("data",date);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentPut = new Intent(context,OrganizerInfoEventActivity.class);
    ...
    class HolderOneNoteOrganizerNow extends RecyclerView.ViewHolder{
        ImageView circleImageView;
        TextView NoteDescription,NoteDate,NoteAssesment;
        CardView cardView;
        public HolderOneNoteOrganizerNow( View itemView) {
            super(itemView);
